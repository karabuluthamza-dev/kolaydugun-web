...
const FakeOnlineCounter = ({ config }) => {
    ...
    return (
        <div className="flex items-center gap-2 text-sm font-medium text-gray-600 bg-white/80 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-sm border border-gray-100">
