...
dictionary.vip = {
    ...
    whatsappForm: {
        tabChat: { en: "AI Assistant", de: "KI-Assistent", tr: "Yapay Zekâ" },
        tabForm: { en: "WhatsApp Form", de: "WhatsApp Formular", tr: "WhatsApp İletişim" },
        title: { en: "Direct WhatsApp Inquiry", de: "Direkte WhatsApp-Anfrage", tr: "Doğrudan WhatsApp İletişimi" },
        subtitle: { en: "Select your inquiry category and submit directly to our WhatsApp support team.", de: "Wählen Sie Ihre Kategorie und senden Sie Ihre Anfrage direkt an unser WhatsApp-Team.", tr: "İhtiyaç kategorinizi seçin, talebiniz doğrudan WhatsApp hattımıza gelsin." },
        selectCategory: { en: "Select Category", de: "Kategorie wählen", tr: "Kategori Seçin" },
        catVenue: { en: "Venue & Services Quote", de: "Hochzeitslocation & Angebote", tr: "Düğün Mekanı & Hizmet Teklifi" },
        catPackage: { en: "All-in-One Package & Budget", de: "Komplettpaket & Budgetberatung", tr: "Düğün Paketi & Bütçe Planlama" },
        ...
        validationError: { en: "Please fill in all required fields (Name & Phone).", de: "Bitte füllen Sie die Pflichtfelder aus (Name & Telefon).", tr: "Lütfen zorunlu alanları (Ad Soyad & Telefon) doldurun." }
    },
    aiChat: {
        triggerTooltip: {
